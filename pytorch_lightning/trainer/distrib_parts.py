...
def check_data_type(device_ids: Any) -> None:
    ...
    """
    if device_ids is not None and (not isinstance(device_ids, (int, str, list)) or isinstance(device_ids, bool)):
        raise MisconfigurationException("Device ID's (GPU/TPU) must be int, string or list of ints or None.")
